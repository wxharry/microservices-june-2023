...
[Code of Conduct](https://github.com/microservices-march/notifier/blob/main/CODE_OF_CONDUCT.md)

## Getting Started

Follow our [Setup Guide](https://github.com/microservices-march/notifier/blob/main/README.md#Setup) to get this repository up and running.
...
* Fill in [our pull request template](https://github.com/microservices-march/notifier/blob/main/.github/pull_request_template.md).
