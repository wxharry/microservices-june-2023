...
Don't know how something in the notifier works? Curious if the notifier can achieve your desired functionality? Please open an Issue on GitHub with the label `question`.
...
Please see the [contributing guide](https://github.com/microservices-march/notifier/blob/main/CONTRIBUTING.md) for guidelines on how to best contribute to this project.
